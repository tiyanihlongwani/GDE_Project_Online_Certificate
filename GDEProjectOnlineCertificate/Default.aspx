<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GDEProjectOnlineCertificate._Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        <div class="container text-center text-md-left" data-aos="fade-up">
            <h1>Welcome to <span>Online Certification System</span></h1>
            <h2>Online Certification</h2>
            <button type="button" class="btn-get-started scrollto" data-backdrop="static" data-toggle="modal" id="btnNew" data-target="#verifyModal">New Registration</button>
        </div>
    </section>
    <main id="main">
        <!-- ======= What We Do Section ======= -->
